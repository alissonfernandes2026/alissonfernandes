  ...
  <article class="card<?= $eh_nova ? ' nova' : '' ?>">
    ...
    <div class="card-body">
      ...
      <div class="campo">
        ...
        <span class="valor"><strong><?= esc($unidade) ?></strong></span>
      </div>
      <?php endif; ?>
      ...
      <?php if ($pncp !== 'NA' && $fonte !== 'Diário Oficial' && stripos($fonte, 'diario') === false): ?>
      <div class="campo">
      ...
      <div class="campo">
        ...
        <div class="objeto-wrap">
          <span class="objeto-texto truncado" id="obj_<?= $uid ?>"><strong><?= esc($objeto) ?></strong></span>
